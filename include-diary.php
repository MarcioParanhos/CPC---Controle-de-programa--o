    ...
    <div class="col-lg-12 mb-4">
      <div class="card">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          ...
          <a title="Consultar" href="diary-consult.php"><button class=" btn btn-sm btn-success"><i class="fa-solid fa-search"></i></button></a>
        </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                      <form class="forms-sample" action="<?= $BASE_URL ?>config/diaryProcess.php" method="post">
                        ...
                        <a title="Salvar"><button type="submit" class=" btn btn-lg bg-purple btn-primary  mr-2"><i class="fa-solid fa-floppy-disk"></i></button></a>
                      </form>
                    </div>
                  </div>
                </div>
